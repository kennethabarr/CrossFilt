...
# bam1=counted so the output carries the original human sequence and XF tag.
crossfilt-filter --xf \
...
expected_se="25a7ff632c6a2fb87856844407e86fd4"
...
expected_pe="d26d2d486656994d5fd6a5b99de2c0c7"
